...
const secret2 = 456; // Second server's secret key
...
app.post('/partial-decrypt', (req, res) => {
    try {
        ...
        console.log('Server 2 received c1:', c1);
        
        // Calculate partial decryption using server's secret
        const partial = modPow(c1, secret2, p);
        
        console.log('Server 2 partial decryption:', partial);
